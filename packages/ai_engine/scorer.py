...
_KEYWORD_VARIANT_HINTS = {
    ...
    "prompt engineering": (("prompt", "engineering"), ("prompt", "driven")),
    "evaluation pipelines": (("evaluation", "pipeline"), ("evaluation", "pipelines"), ("benchmark", "pipeline"), ("benchmarking", "pipelines")),
    "semantic retrieval": (("semantic", "retrieval"), ("semantic", "similarity"), ("embedding",), ("embeddings",)),
...
_RELATED_CONTEXT_TERMS = {
    ...
    "prompt engineering": {"prompt", "prompting", "evaluation", "llm", "agentic", "ai"},
    "evaluation pipelines": {"evaluation", "benchmark", "scoring", "pipeline", "pipelines", "llm"},
    "semantic retrieval": {"semantic", "similarity", "retrieval", "embedding", "embeddings", "llm"},
...
_KEYWORD_CLUSTER_MAP = {
    ...
    "aws": ("aws_cloud",),
    "llms": ("llm_systems",),
    "prompt engineering": ("llm_systems", "agentic_ai"),
    "evaluation pipelines": ("llm_systems", "data_platform"),
    "semantic retrieval": ("llm_systems",),
