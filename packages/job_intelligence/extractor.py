...
_SKILL_LIBRARY: List[Dict[str, Any]] = [
    ...
    {"name": "Prompt Engineering", "category": "ml", "patterns": [r"\bprompt[- ]engineering\b", r"\bprompt[- ]driven\b"]},
    {"name": "Evaluation Pipelines", "category": "ml", "patterns": [r"\bevaluation pipelines?\b", r"\bbenchmark(?:ing)? pipelines?\b"]},
    {"name": "Semantic Retrieval", "category": "ml", "patterns": [r"\bsemantic retrieval\b", r"\bsemantic similarity\b", r"\bembeddings?\b"]},
