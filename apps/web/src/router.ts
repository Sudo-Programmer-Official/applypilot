...
import PortfolioDashboardPage from './pages/PortfolioDashboardPage.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    ...blogPostRoutes,
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            title: 'Portfolio Workspace | ApplyPilot',
            description: 'Generate a live developer profile from resume history and ongoing work logs.',
            canonicalPath: '/dashboard/portfolio',
            robots: 'noindex, nofollow',
          },
        },
      ],
    ...
    },
    {
      ...
      props: true,
      meta: {
        title: 'Developer Profile | ApplyPilot',
        description: 'Public developer activity, proof cards, and project signals generated by ApplyPilot.',
      },
    },
    {
      path: '/privacy',
